...
\begin{frame}{Beispiel zur Iterationsformel}
	...
	\begin{itemize}
		...
		\item $x_{1} = (-1) - \frac{f(-1)}{f^\prime(-1)} = (-1) - \frac{0,5 \cdot (-1)^3 - 2 \cdot (-1)^2 + 0,5 \cdot (-1) + 2}{1,5 \cdot (-1)^2 - 4 \cdot (-1) + 0,5} \approx (-0,833)$	\pause
		\item $x_{2} = (-0,833) - \frac{0,5 \cdot (-0,833)^3 - 2 \cdot (-0,833)^2 + 0,5 \cdot (-0,833) + 2}{1,5 \cdot (-0,833)^2 - 4 \cdot  + 0,5} \approx (-0,814)$	\pause
		\item $x_{3} = (-0,814) - \frac{0,5 \cdot (-0,814)^3 - 2 \cdot (-0,814)^2 + 0,5 \cdot (-0,814) + 2}{1,5 \cdot (-0,814)^2 - 4 \cdot  + 0,5} \approx (-0,814)$
	\end{itemize}
\end{frame}
