...
\begin{frame}{Kehrwertbildung}
	Kehrwertbildung von $A$:
	\begin{itemize}
		\item $\frac{1}{A} = x \rightarrow 0 = \frac{1}{x} - A$
		\item Nullstelle von $f(x) = \frac{1}{x} - A$ gleich $\frac{1}{A}$
		...
		\item daraus ergibt sich die Iterationsfunktion:
			$\begin{array}{rl}
				F(x)	&= x- \frac{\frac{1}{x} - A}{-\frac{1}{x²}}\\
					&= x \cdot (2 - A \cdot x)
			\end{array}$
		\item optimaler Startwert: $x_0 = 4 \cdot (\sqrt{3} - 1) - 2$ 
	\end{itemize}
\end{frame}
